<script>
    $(document).ready(function() {
        let provinceID = @json($customer ?? [] ? $customer->province : []);
        let cityID = @json($customer ?? [] ? $customer->city : []);
        let districtID = @json($customer ?? [] ? $customer->district : []);
        let urbanVillageID = @json($customer ?? [] ? $customer->urban_village : []);
        ...
        function storeCustomer() {
            const customerData = $('#customer-form').serialize();

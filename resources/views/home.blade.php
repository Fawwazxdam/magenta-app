        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-700">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Magenta</span>
                </a>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">Magenta Design <br>Advertising & anything.</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">From Concept to Click – Comprehensive Advertising and Web Development Services</a>.</p>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{asset('assets/images/logo contour.png')}}" alt="hero image" class="drop-shadow-xl">
            </div>
        </div>
    </section>
</body>
